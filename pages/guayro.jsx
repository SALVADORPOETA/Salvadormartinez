...
const guayro = () => {
  return (
    <>
      <Head>
        <title>Guayro Experience | Full-Stack Developer</title>
        <meta
          name="description"
          content="Detailed overview of my experience in Guayro as a marketing specialist."
        />
      </Head>
        ...
        <div className="max-w-[1240px] mx-auto p-2 grid md:grid-cols-5 gap-8 pt-8">
          <div className="col-span-4">
            ...
            <ul className="list-disc list-inside space-y-1 pl-5 pt-2">
              ...
              <li className="cursor-default">
                Preparing financial statements and overseeing reporting to
