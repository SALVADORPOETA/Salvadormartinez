...
const jsm = () => {
  return (
    <>
      <Head>
        <title>Codewars Education | Full-Stack Developer</title>
        <meta
          name="description"
          content="Detailed overview of my education in Codewars solving code exercises."
        />
      </Head>
      <main className="w-full overflow-hidden pb-10">
        ...
        <div className="max-w-[1240px] mx-auto p-2 grid md:grid-cols-5 gap-8 pt-8">
          <div className="col-span-4">
            ...
            <h2>Overview</h2>
            <p className="mt-2">
              Codewars is a globally recognized platform for improving
              programming skills through algorithmic challenges (kata) ranked by
              difficulty. It emphasizes problem-solving, clean code, and mastery
              of language fundamentals, and is widely used by developers to
              strengthen logic, data structures, and algorithmic thinking in a
