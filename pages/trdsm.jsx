...
const trdsm = () => {
  return (
    <>
      <Head>
        <title>
          Trajes Regionales de Segunda Mano Experience | Full-Stack Developer
        </title>
        <meta
          name="description"
          content="Detailed overview of my experience in Trajes Regionales de Segunda Mano as a marketing specialist."
        />
      </Head>
      <main className="w-full overflow-hidden pb-10">
        <div className="w-screen h-[30vh] lg:h-[40vh] relative">
          ...
          <Image
            ...
            objectFit="cover"
            src={trdsmImg}
            alt="Trajes Regionales de Segunda Mano Experience View"
            priority
          />
        ...
        <div className="max-w-[1240px] mx-auto p-2 grid md:grid-cols-5 gap-8 pt-8">
          <div className="col-span-4">
            ...
            <p className="mt-2">
              ...
              responsible for end-to-end sales and marketing operations focused
              on selling second-hand traditional Mexican clothing. My main
            ...
            <p className="mt-2">
              ...
              relationship management, online marketing, conflict resolution,
