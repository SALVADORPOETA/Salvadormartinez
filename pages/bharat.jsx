...
const bharat = () => {
  return (
    <>
      <Head>
        <title>Bharat Project | Full-Stack Developer</title>
        <meta
          name="description"
          content="Detailed overview of Bharat, a full-stack project about Indian culture built with NextJS, Firebase, and a custom NodeJS API."
        />
      </Head>
        ...
        <div className="max-w-[1240px] mx-auto p-2 grid md:grid-cols-5 gap-8 pt-8">
          <div className="col-span-4">
            ...
            <p className="mt-2">
              ...
              because I like world cultures and history. I used NextJS and
              styled it with TailwindCSS. I connected it to an API made by
              myself with NodeJS and fetched the data of the sections "Home",
              "History" and "Languages" through Axios. I tested it with Postman.
              I used Firebase to save the user's access information. I deployed
              it on Vercel.
            </p>
            <p className="mt-2">
              ...
              this is a personal project I don't require verification, so you
              can invent any email and password that you want), then you can
              sign in with your chosen method to access the protected route of
              your Account page.
            </p>
            ...
            <a
              href="https://github.com/SALVADORPOETA/Bharat-sm"
              target="_blank"
            >
