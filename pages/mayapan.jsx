...
const mayapan = () => {
  return (
    <>
      <Head>
        <title>Mayapan Project | Full-Stack Developer</title>
        <meta
          name="description"
          content="Detailed overview of Mayapan, a full-stack project about Maya culture built with NextJS, Firebase, and a custom NodeJS API."
        />
      </Head>
      <main className="w-full overflow-hidden pb-10">
        ...
        <div className="max-w-[1240px] mx-auto p-2 grid md:grid-cols-5 gap-8 pt-8">
          <div className="col-span-4">
            ...
            <a
              href="https://github.com/SALVADORPOETA/Mayapan-sm"
              target="_blank"
            >
