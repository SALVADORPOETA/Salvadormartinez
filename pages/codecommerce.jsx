...
const codecommerce = () => {
  return (
    <>
      <Head>
        <title>Code Commerce Education | Full-Stack Developer</title>
        <meta
          name="description"
          content="Detailed overview of my education in Code Commerce following tutorial videos."
        />
      </Head>
      <main className="w-full overflow-hidden pb-10">
        <div className="w-screen h-[30vh] lg:h-[40vh] relative">
          ...
          <Image
            ...
            objectFit="cover"
            src={codecommerceImg}
            alt="Code Commerce Education View"
            priority
          />
        ...
        <div className="max-w-[1240px] mx-auto p-2 grid md:grid-cols-5 gap-8 pt-8">
          <div className="col-span-4">
            ...
            <p className="mt-2">
              ...
              learn programming. Its goal is for beginners to build real
              projects using current technologies like React, Firebase, Tailwind
              CSS, and Authentication, providing a practical and accessible
              approach to transforming lives through code.
            </p>
            <p className="mt-2">
