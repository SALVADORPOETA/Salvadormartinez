...
const imaginify = () => {
  return (
    <>
      <Head>
        <title>Imaginify Project | Full-Stack Developer</title>
        <meta
          name="description"
          content="Detailed overview of Imaginify, a Software as a Service platform with
              AI-powered features built with NextJS, TypeScript and MongoDB."
        />
      </Head>
      <main className="w-full overflow-hidden pb-10">
        <div className="w-screen h-[30vh] lg:h-[40vh] relative">
          ...
          <Image
            ...
            objectFit="cover"
            src={imaginifyImg}
            alt="Imaginify Project Overview"
            priority
          />
        ...
        <div className="max-w-[1240px] mx-auto p-2 grid md:grid-cols-5 gap-8 pt-8">
          <div className="col-span-4">
            ...
            <p className="mt-2">
              ...
              image restoration, object recoloring, object removal, and
              background removal. Users can create, edit, save, delete, and
              download images. It also features a login system, a home page, a
              profile page, a details page, and an update page.
            </p>
            <p className="mt-2">
              For the frontend, I used Next.js and TypeScript, styled with
              TailwindCSS. The backend is powered by MongoDB, with Clerk
              handling authentication, Stripe for payment processing, and
              Cloudinary API for image transformations. The project is deployed
              on Vercel.
            </p>
