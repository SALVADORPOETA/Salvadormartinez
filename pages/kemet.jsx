...
const kemet = () => {
  return (
    <>
      <Head>
        <title>Kemet Project | Full-Stack Developer</title>
        <meta
          name="description"
          content="Detailed overview of Kemet, a full-stack project about Ancient Egypt built with ReactJS, Firebase, and a custom NodeJS API."
        />
      </Head>
