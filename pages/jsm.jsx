...
const jsm = () => {
  return (
    <>
      <Head>
        <title>JSM Education | Full-Stack Developer</title>
        <meta
          name="description"
          content="Detailed overview of my education in JavaScript Mastery following tutorial videos."
        />
      </Head>
      <main className="w-full overflow-hidden pb-10">
        ...
        <div className="max-w-[1240px] mx-auto p-2 grid md:grid-cols-5 gap-8 pt-8">
          <div className="col-span-4">
            ...
            <h2>Overview</h2>
            <p className="mt-2">
              JavaScript Mastery is a widely recognized YouTube channel focused
              on modern web development. It offers in-depth, project-based
              tutorials that teach best practices and real-world implementations
              using cutting-edge tools and frameworks. The channel is known for
              its clear explanations, practical approach, and strong focus on
              full-stack technologies like React, Next.js, and Node.js, making
              it a valuable resource for developers at all levels.
            </p>
            <p className="mt-2">
