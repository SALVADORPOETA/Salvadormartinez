...
const bellum = () => {
  return (
    <>
      <Head>
        <title>Bellum Experience | Full-Stack Developer</title>
        <meta
          name="description"
          content="Detailed overview of my experience in Bellum Politics as a fullstack developer."
        />
      </Head>
        ...
        <div className="max-w-[1240px] mx-auto p-2 grid md:grid-cols-5 gap-8 pt-8">
          <div className="col-span-4">
            ...
            <p className="mt-2">
              ...
              campaigns through the “Bellum Method,” a comprehensive approach
              that combines public opinion research, voter segmentation,
              political ads, digital content, crisis management, and candidate
              training for interviews and debates. Its mission is to help
              candidates maximize their votes and improve their public
              positioning through a professional and highly effective propaganda
              machine.
            </p>
            ...
            <ul className="list-disc list-inside space-y-1 pl-5 pt-2">
              ...
              <li className="cursor-default">
                Developed Node.js scripts to scrape judicial candidate
                information from Mexico’s INE “Conóceles” website
              ...
              <li className="cursor-default">
                Built an automated email-sending system using Nodemailer,
                capable of dispatching hundreds of personalized emails daily.
                Integrated an email tracking system using invisible pixels
                linked to a remote API, storing engagement results in JSON and
                Excel for performance evaluation and strategic follow-up.
              </li>
              <li className="cursor-default">
            ...
            <ul className="list-disc list-inside space-y-1 pl-5 pt-2">
              <li className="cursor-default">
                Collaborated in writing tailored 1-minute political ad scripts
