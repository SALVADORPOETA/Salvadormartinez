...
const platzi = () => {
  return (
    <>
      <Head>
        <title>Platzi Education | Full-Stack Developer</title>
        <meta
          name="description"
          content="Detailed overview of my education in Platzi studying online courses."
        />
      </Head>
        ...
        <div className="max-w-[1240px] mx-auto p-2 grid md:grid-cols-5 gap-8 pt-8">
          <div className="col-span-4">
            ...
            <p className="mt-2">
              ...
              skills. Additionally, I developed financial literacy through
              courses in personal finance, budgeting, and productivity,
              enhancing both technical and professional competencies. I
              Committed to continuous learning and personal growth through
              project-based, self-paced education.
            </p>
