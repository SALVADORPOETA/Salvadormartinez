...
const storeit = () => {
  return (
    <>
      <Head>
        <title>StoreIt Project | Full-Stack Developer</title>
        <meta
          name="description"
          content="Detailed overview of StoreIt, a full-stack cloud storage management application built with NextJS, TypeScript and Appwrite."
        />
      </Head>
        ...
        <div className="max-w-[1240px] mx-auto p-2 grid md:grid-cols-5 gap-8 pt-8">
          <div className="col-span-4">
            ...
            <p className="mt-2">
              ...
              like Google Drive, Dropbox, and OneDrive, was developed following
              a tutorial by the YouTube channel JavaScript Mastery. The app
              features secure passwordless OTP authentication, a responsive and
              intuitive dashboard for tracking storage usage and recent
              activity, and robust file management capabilities including
              multi-file uploads, renaming, previews, downloads, deletions, and
              sharing. It also supports global search, filtering, detailed file
              views, and role-based access control to manage user permissions
            ...
            <a
              href="https://github.com/SALVADORPOETA/StoreIt-sm"
              target="_blank"
            >
