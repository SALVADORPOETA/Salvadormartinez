...
const podcastr = () => {
  return (
    <>
      <Head>
        <title>Podcastr Project | Full-Stack Developer</title>
        <meta
          name="description"
          content="Detailed overview of Podcastr, a full-stack podcast project built with NextJS, Open AI, Clerk and Convex."
        />
      </Head>
      <main className="w-full overflow-hidden pb-10">
        ...
        <div className="max-w-[1240px] mx-auto p-2 grid md:grid-cols-5 gap-8 pt-8">
          <div className="col-span-4">
            ...
            <h2>Overview</h2>
            <p className="mt-2">
              This platform is a cutting-edge podcast service that eliminates
              the need for a real human voice by leveraging AI-powered features.
              It was developed following a tutorial by the YouTube channel
              JavaScript Mastery. It offers advanced functionalities such as
              ...
              easily discover podcasts through a dedicated search page, create
              new podcasts with integrated text-to-audio conversion and image
